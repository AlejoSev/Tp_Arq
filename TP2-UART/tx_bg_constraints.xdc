...
# Switches
set_property PACKAGE_PIN V17 [get_ports {i_data_rx}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {i_data_rx}]
...
# LEDs
set_property PACKAGE_PIN U16 [get_ports {o_tx}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {o_tx}]
# set_property PACKAGE_PIN E19 [get_ports {o_tx_done_tick}]					
...
#Buttons & reset
# set_property PACKAGE_PIN U18 [get_ports {i_tx_start}]						
# 	set_property IOSTANDARD LVCMOS33 [get_ports {i_tx_start}]
# set_property PACKAGE_PIN T18 [get_ports {i_buttons[1]}]						
# 	set_property IOSTANDARD LVCMOS33 [get_ports {i_buttons[1]}]
# set_property PACKAGE_PIN W19 [get_ports {i_buttons[2]}]						
